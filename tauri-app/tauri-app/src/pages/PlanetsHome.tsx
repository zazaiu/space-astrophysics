// src/pages/PlanetsHome.tsx
import { Link } from 'react-router-dom';
import './PlanetsHome.css'; // Добавляем импорт CSS
      ...
      <div className="home-content">
        <div className="home-card">
          ...
          <p className="home-description">
            ...
            и создавать заявки на исследования. Используйте современные алгоритмы 
            для точных астрономических расчетов.
          </p>
          ...
          <Link to="/planets" className="select-button" style={{ marginTop: '50px' }}>
            Начать исследование
          </Link>
        </div>
      </div>
