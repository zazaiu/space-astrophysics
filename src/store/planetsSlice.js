...
export const updatePlanet = createAsyncThunk('planets/updatePlanet', async ({ id }) => {
    const response = await PlanetsService.putPlanets(id);
    return response;
});
export const deletePlanet = createAsyncThunk('planets/deletePlanet', async ({ id }) => {
